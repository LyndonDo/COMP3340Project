        ...
        <tbody>
          <?php 
            ...
            if(isset($_GET['search'])) {
              $filtervalues = $_GET['search']; // Access The Input Tag That Has "search"
              $query = "SELECT * FROM games WHERE CONCAT(title, genre, platforms, editions, releasedate) LIKE '%$filtervalues%' "; // Get Query From "games" Database
              $query_run = mysqli_query($connect, $query); // Get Results From The Query
              ...
              if(mysqli_num_rows($query_run) > 0) {
                foreach($query_run as $items) {
                  ...
                  ?> 
                    <tr>
                      ...
                      <td><?= $items['title']; ?></td>
                      <td><?= $items['genre']; ?></td>
                      <td><?= $items['platforms']; ?></td>
                      <td><?= $items['editions']; ?></td>
                ...
                // Displaying No Results For Game
                ?>
                  <tr>
                    <td>No Results</td>
                  </tr>
