...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Refine Your Recommendation</title>
  ...
  <body>
    ...
    <div class="form-wrapper">
      <form style="margin: 50px 0 50px 0;" class="form-container" action="" method="post">
        <h2 style="text-align: center;">Type In Your Game</h2>
        <div class="question-container">
          <label for="gameinput">Game: </label>
          <input type="text" name="gameinput" placeholder="Game Name" required>
        </div>
        
        <br>

        <h2 style="text-align: center;">Type In Your Game Console?</h2>
        <div class="question-container">
          <label for="consoleinput">Console: </label>
          <select name="gameconsoles">
            <option value="Console">PlayStation</option>
            <option value="Console">Xbox</option>
            <option value="Console">Nintendo</option>
            <option value="Console">PC</option>
          </select>
        </div>

        <br>

        <h2 style="text-align: center;">(Optional) Preferences?</h2>
        <div class="question-container">
          <label for="preferencesinput">Preferences: </label>
          <input type="text" name="preferencesinput" placeholder="Preferences">
        </div>

        <br>

        <h2 style="text-align: center;">What Price Range Do You Want?</h2>
        <div class="question-container">
          <input type="radio" name="Priority1" value="High">
          <label for="Priority1">High</label><br>
          <input type="radio" name="Priority2" value="Medium">
          <label for="Priority2">Medium</label><br>
          <input type="radio" name="Priority3" value="Low">
          <label for="Priority3">Low</label><br>
        </div>

        <br>

        <h2 style="text-align: center;">Do Your Want Something New Or Popular?</h2>
        <div class="question-container">
          <input type="radio" name="Notify1" value="Popular">
          <label for="Notify1">Notify Price Down</label><br>
          <input type="radio" name="Notify2" value="New">
          <label for="Notify2">Notify New Editions</label><br>
        </div>
        <br>
        <br>
        <div class="selection-container">
          <input class="btn" type="submit" name="seemygame" value="See My Game">
        </div>
      </form>
    </div>
    <br>
