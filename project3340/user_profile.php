...
<body>
    ...
    <div style="display: flex; justify-content: center; align-items: center; margin-top: 80px;">
        ...
        <div>
            ...
            <h5>User Id: <?php echo $user_data['user_id']?></h5>
            <h5>Date Joined: <?php echo $user_data['date']?></h5>
            <a href="userlogout.php"><button class="button" type="button">Log Out</button></a>
        </div>
    </div>
