...
<body>
  <header>
    ...
    <h1 style="text-align: center">Game News</h1>
    ...
    <div class="card-container">
      <div class="news-card">
        <img src="images/destiny2.png" alt="Destiny 2">
        <div class="news-container">
          <h2>Destiny 2 New Updates</h2>
          <p>News About The New Updates For Destiny 2.....</p>
        </div>
      </div>
      ...
      <div class="news-card">
        ...
        <div class="news-container">
          <h2>Apex Legends New Updates</h2>
          <p>News About The New Updates For Apex Legends.....</p>
        </div>
      </div>
      ...
      <div class="news-card">
        ...
        <div class="news-container">
          <h2>Rocket League New Updates</h2>
          <p>News About The New Updates For Rocket League.....</p>
        </div>
      </div>

      <div class="news-card">
        <img src="images/rainboxsixsiegex.png" alt="Rainbow Six Siege X">
        <div class="news-container">
          <h2>Rainbow Six Siege X New Updates</h2>
          <p>News About The New Updates For Rainbow Six Siege X.....</p>
        </div>
      </div>
      ...
      <div class="news-card">
        ...
        <div class="news-container">
          <h2>PUBG New Updates</h2>
          <p>News About The New Updates For PUBG.....</p>
        </div>
      </div>
    </div>
